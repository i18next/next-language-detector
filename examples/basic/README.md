...
This is a simple example of how to use [next-i18next](https://github.com/i18next/next-i18next) with [Next.js](https://github.com/zeit/next.js) for a complete static website and optional use of [locize](https://www.locize.com?utm_source=next_language_detector_basic_readme&utm_medium=github&utm_campaign=examples_basic_readme) to get translations up and running quickly and easily.
...
**A step by step guide can be found in [this tutorial](https://www.locize.com/blog/next-i18n-static?utm_source=next_language_detector_basic_readme&utm_medium=github&utm_campaign=examples_basic_readme).**

## optional [locize](https://www.locize.com?utm_source=next_language_detector_basic_readme&utm_medium=github&utm_campaign=examples_basic_readme) usage (not mandatory)
